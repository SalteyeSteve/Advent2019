...
function draw($direction, $amount, $position)
{
    // get last position
    ...
    {
        case 'U':
            $startPosition['y'] = $startPosition['y'] + $amount;
            break;
        case 'R':
            $startPosition['x'] = $startPosition['x'] + $amount;
            break;
        case 'L':
            $startPosition['x'] = $startPosition['x'] - $amount;
            break;
